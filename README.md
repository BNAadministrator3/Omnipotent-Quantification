...
| 9          | Latency (ms) of conv/linear in om-like-formatted model from 5                            |           |
| 10          | Latency (ms) of conv/linear in om-like-formatted model from 2 (Note AOE opt. is also needed)                           |           |
| 11          | Latency (ms) of conv/linear in om-like-formatted model from 3                            |           |
...
| os1        | maximal conv/linear speedup, i.e., div(10, 9)                                                           |           |
| os2        | conv/linear speedup (%) of ours, i.e., div(10,11)                                                       |           |
